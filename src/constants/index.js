  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        ...
        "Developed interconnection diagrams in AutoCAD for 30+ FEJA solar field projects, ensuring installations complied with customer requirements and the National Electrical Safety Code (NESC).",
        "Conducted site visits to identify and document potential electrical feeder extensions and equipment placements that could interface with customers' existing electrical systems and support future solar field expansions.",
