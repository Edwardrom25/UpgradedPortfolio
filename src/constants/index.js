import {
  ...
  const experiences = [
    ...
    {
      title: "Power Distribution Engineering Intern",
    ...
    },
    {
      ...
      points: [
        "Supported the new product development (NPD) and quality teams in designing and testing synthetic fabrics, metal, and plastic components for cleaning products used in ISO 5–ISO 8 cleanrooms in the aerospace industry.",
        ...
        "Designed a test method to compute the coefficient of friction of synthetic cleaning fabrics, providing the sales team with a data-driven metric to highlight the ergonomic advantages of Vileda Professional products over competitors.",
