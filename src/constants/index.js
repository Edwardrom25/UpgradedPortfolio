  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        ...
        "Programmed a Universal Robots UR5 Cobot Arm to continually expose a wheel cleaner prototype to the forces it is expected to undergo over its lifetime to reveal component failures and determine its operational lifespan.",
